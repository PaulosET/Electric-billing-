        ...
        <div class="modal-content">
            ...
            <form wire:submit.prevent="storeBrand">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label>Status</label>
                        <input type="checkbox" wire:model.defer="status" /> <br /> Checked=Hidden,Un-Checked=Visible
                    </div>
                </div>
                ...
                <form wire:submit.prevent="updateBrand">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" wire:model.defer="name" class="form-control">
                            @error('name')
                                <small class="tex-dangert">{{ $message }}</small>
                            @enderror
                        ...
                        <div class="mb-3">
                            <label>Status</label>
                            <input type="checkbox" wire:model.defer="status" style="width:70px;height=70px;" /> <br />
        ...
        <div class="modal-content">
            ...
            <div wire:loading.remove>
                ...
                <form wire:submit.prevent="destroyBrand">
                    <div class="modal-body">
                        <h4>Are you sure you want to delte this data?</h4>
                    </div>
