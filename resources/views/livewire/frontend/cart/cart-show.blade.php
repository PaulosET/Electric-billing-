        ...
        <div class="container">
                                                    ...
                                                    @if ($cartItem->productColor)
                                                        ...
                                                        <span>
                                                            @if ($cartItem->productColor->color)
                                                                with color:{{ $cartItem->productColor->color->name }}
                                                            @endif
                                                    @endif
                                                    </span>
                                                </label>
                                            ...
                                            <div class="quantity">
                                                <div class="input-group">
                                                    <button type="button" wire:loading.attr="disabled"
                                                        wire:click="decrimentQuantity({{ $cartItem->id }})"
                                                        class="btn btn1"><i class="fa fa-minus"></i></button>
                                                    <input type="text" value="{{ $cartItem->quantity }}"
                                                        class="input-quantity" />
                                                    <button type="button" wire:loading.attr="disabled"
                                                        wire:click="incrimentQuantity({{ $cartItem->id }})"class="btn btn1"><i
            ...
            <div class="row">
                <div class="col-md-8 my-md-auto mt-3">
                    <h5>
                        Get the best deal & Offers<a href="{{ '/collections' }}"> Shop now</a>
                    </h5>
                </div>
