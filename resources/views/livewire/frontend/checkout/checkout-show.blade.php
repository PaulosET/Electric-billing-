        ...
        <div class="container">
                                        ...
                                        <div class="tab-content col-md-9" id="v-pills-tabContent">
                                            ...
                                            <div class="tab-pane fade" id="onlinePayment" role="tabpanel"
                                                ...
                                                {{--  <button wire:loading.attr="disabled"
                                                    type="button"wire:click="onlineOrder()" class="btn btn-warning">Pay
                                                    Now (Online
                                                    Payment)</button> --}}
                                                <div wire:ignore>
            ...
            @else
                <div class="card card-body shadow text-center p-md-5">
                    <h4>No items is the cart to check out</h4>
...
@push('scripts')
    <script
        src="https://www.paypal.com/sdk/js?client-id=AR9kMy7ssZTTb3HJv7vCcnWG-XjEfcQ_8HmfhejFKVs_-izr9Rp4YE1d63Bs-bt4otGhUr9VLaJiMZE8&currency=USD">
    </script>
    <script>
        paypal.Buttons({
            onClick: function() {
                // Show a validation error if the necessary fields are not filled
            ...
            createOrder: function(data, actions) {
                return actions.order.create({
                    purchase_units: [{
                        amount: {
                            value: "{{ $this->totalProductAmount }}" // Set the amount for the order
                        }
                    }]
                });
            },
