                ...
                <div class="col-md-7 mt-3">
                    <div class="product-view">
                        ...
                        <p class="product-path">
                            <a href="{{ url('/collections/') }}" class="text-decoration-none"> Home</a> / <a
                                href="{{ url('/collections/' . $product->category->slug) }}"
                                class="text-decoration-none">{{ $product->category->name }}</a> / <a
                        ...
                        <div class="mt-2">
                            ...
                            <div class="mt-2">
                                ...
                                <button href="" wire:click="addToCart({{ $product->id }})" type="button"
                                    class="btn btn1"> <i class="fa fa-shopping-cart"></i> Add To Cart
                                </button>

                                <button wire:click="addToWishList({{ $product->id }})"href="button" class="btn btn1">
