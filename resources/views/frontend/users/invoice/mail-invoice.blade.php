...
<div class="text-center">
    ...
    <p>
        Thank you for purchasing with {{ $appSetting->website_name ?? 'website name' }} 
        <br/>
        ...
        <thead>
            <tr>
                ...
                <th width="50%" colspan="2" class="text-end company-data">
                    ...
                    <span>Zip code : 560077 componey zip code</span> <br>
                    <span>
                        {{ $appSetting->address ?? '#444, some main road, some area, some street, AddisAbaba, Ethipia - 560077' }}</span>
                    <br>
                </th>
            </tr>
            <tr class="bg-blue">
    ...
    <br>
    <p class="text-center">
        Thank your for shopping with componey name
    </p>
