    ...
    <div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="mb-2"><a href="{{ url('contact_us') }}" class="text-white">Contact Us</a></div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="mb-2">
                            <p>
                                ...
                                {{ $appSetting->address ?? '#444, some main road, some area, some street, AddisAbaba, Ethipia - 560077' }}
                            </p>
                        </div>
                        <div class="mb-2">
        ...
        <div class="copyright-area">
            <div class="container">
                <div class="row">
                    <div class="col-md-8">
                        <p class=""> &copy; 2023 - {{ $appSetting->website_name ?? 'websit name' }}. All rights
                            reserved.</p>
                    </div>
                    <div class="col-md-4">
